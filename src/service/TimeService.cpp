/* Copy-pasted from https://github.com/PaulStoffregen/Time/blob/master/examples/TimeNTP_ESP8266WiFi/TimeNTP_ESP8266WiFi.ino */
...
const int timeZone = 0; // Coordinated Universal Time
